<%-- 
    Document   : admin
    Created on : Oct 27, 2020, 9:09:34 PM
    Author     : HOME
--%>
                                    ...
                                    <c:forEach var="item" items="${requestScope.INFO}">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-6">
                                            <div class="product__item">                                                     
                                                <form action="RoomDetailController" method="POST">     
                                                    <button value="RoomDetail" type="submit" class="btn">
                                                        <span class="img-hover-zoom">
                                                            <img src="${item.image}">                                                                     
                                                        </span>
                                                        <input type="hidden" name="txtHotelID" value="${item.hotelID}"/>
                                                        <input type="hidden" name="txtHotelName" value="${item.name}"/>
                                                        <input type="hidden" name="txtHotelImage" value="${item.image}"/>
                                                    </button>                                                     
                                                </form> 
