...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (session == null || session.getAttribute("ROLE") == null) {
            ...
            if (role != null) {
                if (role.equals("user")) {
                    if (user.contains(resource) || resource.endsWith("js") || resource.endsWith("css") || resource.endsWith("woff2") || resource.endsWith("woff") || resource.endsWith("ttf") || resource.endsWith("jpg") || resource.endsWith("png") || resource.endsWith("jpeg") || resource.endsWith("jfif") || resource.endsWith("map") || resource.endsWith("svg") || resource.endsWith("eot")  || resource.endsWith("scss")) {
                        chain.doFilter(request, response);
                    } else {
